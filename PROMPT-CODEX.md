...
Objetivo: manter uma aplicação escolar simples, sem login e sem autenticação, hospedada como Web Service gratuito no Render, usando Django, templates, JavaScript puro e SQLite.
...
3. Preservar o deploy pelo `render.yaml`, `build.sh` e `start.sh`.
4. Usar SQLite e aceitar conscientemente o armazenamento efêmero do Render gratuito.
